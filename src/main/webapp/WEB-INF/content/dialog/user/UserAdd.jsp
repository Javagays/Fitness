...
$(function() {
	...
	User.add = function() {
		var dg=$("#userDataGrid");
		var url = "User/save";
		uiEx.submitURLAjax("#userAddForm", url, function(data) {
			data = eval("(" + data + ")");
			// 执行成功，刷新dg
			if (data.statusCode==200) {
				...
				uiEx.closeDialog("#userAddDialog");
			} 
...
<!-- 添加或修改Dialog -->
<div id="userAddDialog" class="easyui-dialog"
...
<div id="userAdd-dlg-buttons">
	<a class="easyui-linkbutton" id="userAddSaveBtn" iconCls="icon-ok"
		onclick="User.add()">添加</a> <a class="easyui-linkbutton"
		iconCls="icon-cancel"
		onclick="javascript:uiEx.closeDialog('#userAddDialog')">取消</a>
</div>
</div>
