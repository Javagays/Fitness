...
<html>
  <head>
    ...
    <title>EasyEE-SM Management</title>
...
<body class="easyui-layout" >
 ...
 --%>
		...
		<div id="easysshtop" data-options="region:'north',split:true"
			style="height:120px;padding: 0 20px;" title="EasyEE-SM Demo ( SpringMVC 4.X + MyBatis 3.4 + EasyShiro 2.X + EasyFilter 2.X + EasyUI + EasyUIEX )">
			<h1 style="display: inline;line-height: 80px;font-size: 32px;font-family: 'Roboto Condensed', 微软雅黑; font-weight: 700; ">
			
		<%-- 	<img alt="" src="images/logo.png"/> --%>  
		<span style="color:#8FC31F">Easy</span><span style="color:#376E91">E</span><span style="color:#376E91">E</span>-<span style="color:#000000">SM</span> Basic Development Platform
			</h1>
